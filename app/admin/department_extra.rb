ActiveAdmin.register DepartmentExtra do  
  ...
  index do         
     ...
     column :fixed_name, sortable: :name do |dept_extra| 
       editable_text_column dept_extra, "department_extra", :fixed_name, true
     end     
     ...
     column :chair_name do |dept_extra| 
       editable_text_column dept_extra, "department_extra", :chair_name, false
     end
     # column :chair_email do |resource| 
     #   editable_text_column resource, "department_extra", :chair_email, false
     # end
     # column :chair_title do |resource| 
     #   editable_text_column resource, "department_extra", :chair_title, false
     # end
     actions
  end   
