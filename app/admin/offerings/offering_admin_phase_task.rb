			...
			unless f.object.new_record?
				tab "Extra Fields (#{tasks.extra_fields.size})" do
				  panel 'Extra Fields to Display' do
		              ...
		              div link_to '<span class="mi md-20 bottom_align">add</span>Add New Extra Field'.html_safe, new_admin_offering_phase_task_extra_field_path(offering, phase, tasks), class: 'button add'
		            end
		        end
				end
			end
